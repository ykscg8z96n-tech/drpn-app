...
const SECTIONS = [
  ...
  },
  {
    ...
    color: '#0078FF',
    title: 'Home',
    body: 'Create your own events (one-time) or groups (ongoing) under the Events/Groups tabs. Swipe an item left to reveal Roster, Edit, Invite, and Cancel if you organize it.',
  },
  {
    icon: 'people',
    color: '#0078FF',
